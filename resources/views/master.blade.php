...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="{{route('shopcartpage')}}" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
    ...
    <div class="row align-items-center">
      ...
      <div class="col-3">
        <a href="{{route('propage')}}" class="text-decoration-none text-dark font-weight-bold"> Promotion </a>
      </div>
      <div class="col-3">
  ...
  <div id="mySidebar" class="sidebar">
    ...
    <div class="mt-3">
      ...
      <hr>
        ...
        <a href="{{route('propage')}}"> Poromotion </a>
      <hr>
